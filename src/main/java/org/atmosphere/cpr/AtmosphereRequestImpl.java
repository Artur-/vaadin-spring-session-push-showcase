...
public class AtmosphereRequestImpl extends HttpServletRequestWrapper implements AtmosphereRequest {
    ...
    private transient ServletInputStream voidStream = new IS(new ByteArrayInputStream(new byte[0]));
    ...
    public AtmosphereRequestImpl(Builder b) {
    ...
    public final static class Builder implements AtmosphereRequest.Builder {
        ...
        public Body body;
        private transient LocalAttributes localAttributes = new LocalAttributes();
    ...
    public final static class Body implements Serializable {
    ...
    private void readObject(ObjectInputStream stream)
        ...
        voidStream = new IS(new ByteArrayInputStream(new byte[0]));
    }
